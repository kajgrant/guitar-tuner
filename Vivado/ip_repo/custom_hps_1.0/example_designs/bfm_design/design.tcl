proc create_ipi_design { offsetfile design_name } {
	...
	set custom_hps_0 [ create_bd_cell -type ip -vlnv sfu.ca:user:custom_hps:1.0 custom_hps_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores sfu.ca:user:custom_hps:1.0]]]]
