...
HD_PWD='C:/KDevelop/guitar-tuner/Vivado/audio/audio.runs/ip_design_xfft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_design_xfft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_design_xfft_0_0.tcl
