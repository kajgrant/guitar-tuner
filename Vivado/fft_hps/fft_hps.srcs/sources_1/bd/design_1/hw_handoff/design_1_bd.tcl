...
proc create_hier_cell_accelerator { parentCell nameHier } {
  ...
  create_bd_pin -dir O m_axis_data_tlast1
  create_bd_pin -dir O m_axis_data_tvalid1
  ...
  connect_bd_net -net xfft_0_m_axis_data_tdata [get_bd_pins m_axis_data_tdata1] [get_bd_pins xfft_0/m_axis_data_tdata]
  connect_bd_net -net xfft_0_m_axis_data_tlast [get_bd_pins m_axis_data_tlast1] [get_bd_pins xfft_0/m_axis_data_tlast]
  connect_bd_net -net xfft_0_m_axis_data_tvalid [get_bd_pins m_axis_data_tvalid1] [get_bd_pins xfft_0/m_axis_data_tvalid]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net accelerator_M_AXIS_DATA [get_bd_intf_pins accelerator/M_AXIS_DATA] [get_bd_intf_pins cordic_0/S_AXIS_CARTESIAN]
  ...
  connect_bd_intf_net -intf_net cordic_0_M_AXIS_DOUT [get_bd_intf_pins cordic_0/M_AXIS_DOUT] [get_bd_intf_pins ctrl/S_AXIS_ACCEL]
  ...
  # Create port connections
  connect_bd_net -net accelerator_m_axis_data_tdata1 [get_bd_pins accelerator/m_axis_data_tdata1] [get_bd_pins cordic_0/s_axis_cartesian_tdata]
  connect_bd_net -net accelerator_m_axis_data_tlast1 [get_bd_pins accelerator/m_axis_data_tlast1] [get_bd_pins cordic_0/s_axis_cartesian_tlast]
  connect_bd_net -net accelerator_m_axis_data_tvalid1 [get_bd_pins accelerator/m_axis_data_tvalid1] [get_bd_pins cordic_0/s_axis_cartesian_tvalid]
  ...
  connect_bd_net -net processing_system7_0_fclk_clk0 [get_bd_pins accelerator/aclk] [get_bd_pins cordic_0/aclk] [get_bd_pins ctrl/ctrl_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
